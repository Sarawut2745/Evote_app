...
import { faTachometerAlt, faCog,  faImage, faUsers} from '@fortawesome/free-solid-svg-icons';
...
const menuGroups = [
  {
    ...
    menuItems: [ 
      ...
      { icon: (<FontAwesomeIcon icon={faUsers} />), label: "จัดการผู้ใช้งาน", route: "/admin/user_manage" }
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      ...
      >
        {/* <!-- SIDEBAR HEADER --> */}
        <div className="flex items-center justify-between gap-3 px-16 py-3.5 lg:py-6.5">
          <Link href="/">
            <Image
              width={100}
              height={20}
          ...
          <label className="text-white text-2xl">Admin</label>
          <button
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          {/* <!-- Sidebar Menu --> */}
          <nav className="mt-5 px-4 py-2 lg:mt-1 lg:px-6">
